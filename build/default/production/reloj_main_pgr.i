...
CONFIG WRT = OFF ; Flash Program Memory Self Write Enable bits (Write protection off)
 ...
 TEMP_TABLA_DIAS: DS 1
 TEMP_SUMA: DS 1
 TEMP_DIAS1_DIAS2: DS 1
 TEMP_MES1_MES2: DS 1
 ...
 int_timer1:
    ...
    CALL contador_alarma

    BTFSC PORTE, LED_ALARMA_ON
 ...
 inc_dia:
    ...
    CALL tabla_dias
    MOVWF TEMP_TABLA_DIAS

    CLRF TEMP_DIAS1_DIAS2
    CLRF TEMP_SUMA
    MOVF DIAS1, W
    ADDWF TEMP_DIAS1_DIAS2, 1
    MOVF DIAS2, W
    ADDWF TEMP_DIAS1_DIAS2, 1
 ...
 int_timer2:
    ...
    BCF ((STATUS) and 07Fh), 2
    MOVF TEMP_VALOR_TIMER, W

    BTFSC ((STATUS) and 07Fh), 2
    GOTO activar_alarma_timer
 ...
 int_underflow_timer_segundos:
    ...
    BTFSS ((STATUS) and 07Fh), 2
    RETURN
    CALL int_underflow_timer_minutos
    RETURN
 ...
 hora:
    ...
    CLRF DISPLAY
    set_display MINUTOS1, MINUTOS2, HORAS1, HORAS2
 ...
 fecha:
    ...
    CLRF DISPLAY
    set_display MES1, MES2, DIAS1, DIAS2
 ...
 timer:
    ...
    CLRF DISPLAY
    set_display TSEGUNDOS1, TSEGUNDOS2, TMINUTOS1, TMINUTOS2
